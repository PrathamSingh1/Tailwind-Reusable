    ...
    <div className="relative h-full w-full flex items-center justify-center">
      <div className="relative z-10 h-80 w-60 p-5 bg-neutral-100 dark:bg-neutral-900 shadow-2xl border border-neutral-200 dark:border-neutral-800 rounded-xl">
        <div className="mask-t-from-80%">
          ...
          <h3 className="text-sm font-medium text-nowrap mt-2 animate-marquee">
            Unleash the power of tailwindcss
          </h3>
          <Image
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <button
              ...
              className="text-sm font-medium px-3 py-1.5 rounded-xl text-neutral-800 dark:text-neutral-100 bg-neutral-200 dark:bg-neutral-800"
            >
              Switch Theme
            </button>
          </div>
